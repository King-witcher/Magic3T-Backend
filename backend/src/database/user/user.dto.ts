...
export class UserPayload implements UserPayloadType {
  ...
  @ApiProperty({
    description: "The user role in Magic3T. Can be either 'player', 'bot', or 'creator'",
    default: 'player',
    example: 'creator',
  ...
  static async fromRow(row: UserRow, ratingService: RatingService): Promise<UserPayload> {
