...
import { IStateHandler, PlayerState } from '@modules/match/lib/player.state'
import { Choice } from '@/types/Choice'
import { Observable } from '@/lib/observable'
import { PlayerStatus } from '@modules/match/types/PlayerStatus'
...
export class MatchHandler extends Observable<MatchEventsMap> {
  ...
  public getAdapter(side: SidesEnum): IMatchAdapter {
    const self = this
    return {
