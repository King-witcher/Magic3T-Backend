...
export const RANKS = [
  {
    ...
    icon: `${import.meta.env.VITE_CDN_URL}/leagues/emblems/bronze.png`,
  },
  {
    name: 'Silver',
    divisions: ['IV', 'III', 'II', 'I'],
    ...
    icon: `${import.meta.env.VITE_CDN_URL}/leagues/emblems/silver.png`,
  },
  {
    name: 'Gold',
    divisions: ['IV', 'III', 'II', 'I'],
    ...
    icon: `${import.meta.env.VITE_CDN_URL}/leagues/emblems/gold.png`,
  },
  {
    name: 'Diamond',
    divisions: ['IV', 'III', 'II', 'I'],
    ...
    icon: `${import.meta.env.VITE_CDN_URL}/leagues/emblems/diamond.png`,
  },
  {
    name: 'Master',
    divisions: null,
    ...
    icon: `${import.meta.env.VITE_CDN_URL}/leagues/emblems/master.png`,
  },
  {
    name: 'Challenger',
    divisions: null,
    ...
    icon: `${import.meta.env.VITE_CDN_URL}/leagues/emblems/challenger.png`,
    special: true,
  },
]
